...
async function main() {
  ...
  // A negative inside result is never shown as a raw number — real
  ...
  assert.strictEqual(negProbe.zeroDisplay, 0, 'displaySum should show 0 as a real number, not the "No score" placeholder');
